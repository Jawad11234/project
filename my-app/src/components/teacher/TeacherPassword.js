...
const TeacherPassword = () => {
    ...
    const teacherPassword =async () =>{
        await Axios.post('http://localhost:3001/teacherspassword',{
                ...
                <div className="text-center">
                    ...
                    <div className="card-body">
                        ...
                        <form className="">
                            ...
                            <div className="text-center">
                            <button type="submit" className="btn buttonstyle mx-3" onClick={teacherPassword}>
                                Get Password
                            </button>
                            <Link className='btn buttonstyle' to='/teacherlogin'>Login</Link>
                            </div>
                        </form>
                    </div>
                </div>
